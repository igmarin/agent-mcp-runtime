...
If you identify a security vulnerability, please do not open a public issue. Instead, report it privately to the repository maintainer.

- **Contact Email**: `security@example.com` (please replace with the canonical maintainer contact details when deploying publicly)
